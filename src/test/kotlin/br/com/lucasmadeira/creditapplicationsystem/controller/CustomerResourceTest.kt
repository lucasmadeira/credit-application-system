...
class CustomerResourceTest {
    ...
    fun `should create a customer and return 201 status`(){
        ...
        mockMvc.perform(MockMvcRequestBuilders.post(URL)
            ...
            .andExpect(MockMvcResultMatchers.jsonPath("$.lastName").value("Madeira"))
            .andExpect(MockMvcResultMatchers.jsonPath("$.cpf").value("28475934625"))
            .andExpect(MockMvcResultMatchers.jsonPath("$.email").value("lucas@email.com"))
            .andExpect(MockMvcResultMatchers.jsonPath("$.income").value(1000.0))
            .andExpect(MockMvcResultMatchers.jsonPath("$.zipCode").value("000000"))
            .andExpect(MockMvcResultMatchers.jsonPath("$.street").value("Rua do Lucas, 123"))
    ...
    fun `should update a customer and return 200 status`() {
        ...
        mockMvc.perform(
            ...
            .andExpect(MockMvcResultMatchers.status().isOk)
            .andExpect(MockMvcResultMatchers.jsonPath("$.firstName").value("LucasUpdate"))
            .andExpect(MockMvcResultMatchers.jsonPath("$.lastName").value("MadeiraUpdate"))
            .andExpect(MockMvcResultMatchers.jsonPath("$.cpf").value("28475934625"))
            .andExpect(MockMvcResultMatchers.jsonPath("$.email").value("lucas@email.com"))
    ...
    private fun builderCustomerDto(
        ...
        street: String = "Rua do Lucas, 123",
    ) = CustomerDTO(
        firstName = firstName,
        lastName = lastName,
        cpf = cpf,
